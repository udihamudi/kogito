...
////
Exception while fetching data (/ProcessInstances[0]/source) : JDBC exception executing SQL [select m1_0.node_id,m1_0.process_id,m1_0.process_version,m1_0.key,m1_0.value from definitions_nodes_metadata m1_0 where (m1_0.node_id,m1_0.process_id,m1_0.process_version) in ((?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?),(?,?,?))] [ERROR: column m1_0.key does not exist   Position: 58] [n/a]


//// adding to my maildover.com git
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$ cat ~/.ssh/id_rsa.pub
ssh-rsa  maildover@gmail.com
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
...
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$ git remote add origin https://github.com/udihamudi/kogito.git
fatal: not a git repository (or any parent up to mount point /mnt)
Stopping at filesystem boundary (GIT_DISCOVERY_ACROSS_FILESYSTEM not set).
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$ git init
...
Initialized empty Git repository in /mnt/c/udi/rpb124/.git/
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$ git remote set-url origin git@github.com:udihamudi/kogito.git
error: No such remote 'origin'
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$ git remote add origin git@github.com:udihamudi/kogito.git
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$ git remote -v
origin  git@github.com:udihamudi/kogito.git (fetch)
origin  git@github.com:udihamudi/kogito.git (push)
kudi@US-PF3TFL55:/mnt/c/udi/rpb124$
