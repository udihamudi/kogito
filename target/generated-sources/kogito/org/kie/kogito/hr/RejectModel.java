...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "reject", name = "Reject", hidden = false)
public class RejectModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<RejectModelOutput> {
    ...
    @Override()
    public RejectModelOutput toModel() {
        RejectModelOutput result = new RejectModelOutput();
        result.setId(getId());
